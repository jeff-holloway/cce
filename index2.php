...
<div class="column move_box_left">
     			...
     			<div class="search_box">
     				...
     				<? if($_SESSION['access_level'] >=90) { ?>
     					<div style='float:right; margin-right:20px;'>
     						...
     						<button type="submit" id='create-merch' name='create-merch' class="btn btn-default add_new_btn"  style='margin-left:20px;' onClick='edit_merchant(0,1);'>ADD CUSTOMER</button>
     						
     						&nbsp; &nbsp; &nbsp; 
     						<button type="submit" id='create-store' name='create-store' class="btn btn-default add_new_btn" style='margin-left:20px;' onClick='edit_store_location(0,1);'>ADD STORE</button>
							...
							<tr>
							  	<td colspan='2'>							  		
							  		...
							  		if($_SESSION['access_level'] >=90)
							  		{
							  			...
							  			echo "<input type='button' name='create-new-merchant' id='create-new-merchant' value='Add' onClick='edit_merchant(0,1);' class='btn btn-default add_new_btn'>";	
					...
					<?         
                         ...
                         <div id='dialog_merchant_form' title='Add/Edit Customer' style='display:none;'>
                         	...
                         	<div class='field2'>
                         		...
                         		<span>
                         			<input type='text' name='ms_merchant' id='ms_merchant' value='Customer Name'>
			...
			<div class="portlet-content">
					<table class="table table-striped" id='mrr_store_display'>
						  <tbody>
							...
							<tr>
							  <td>ADDRESS<br><span id='store_loc_addr1'></span></td>
							...
							<tr>
							  	<td colspan='2'>	
							  		...
							  		{	// && ($_SESSION['merchant_id'] > 0 || ($_SESSION['merchant_id']==0 && $_SESSION['selected_merchant_id'] > 0) ) 
							  			echo "<div class='right_floater'><input type='button' name='create-new-store' id='create-new-store' value='Add' onClick='edit_store_location(0,1);' class='btn btn-default add_new_btn'></div>";	
							  		}
							  		?>	
					...
					<?         
                         ...
                         <div id='dialog_store_form' title='Add/Edit Store Location' style='display:none;'>
                         	<p class='validateTips'>*** DBA Name and Store Number fields are required.  <br>If left blank, Customer will be used to fill in some of the Store Location settings.</p>
                         	<div class='field2'>
		...
		<div class="portlet left_col edit_user" id='portlet_EditUser'>
			...
			<div class="portlet-header default_closed">Manage Users</div>
			<div class="portlet-content">
	...
	<!--
     <div id='auditor_folder_holder' style='width:100%; display:none;'>
...
<script type='text/javascript'>
	...
	{		
		...
		<? if($_SESSION['access_level']==45) { ?>
			...
			$('.home_page').removeClass('active_side_menu');
			$('.audit_folder').addClass('active_side_menu');
		...
		<? } else { ?>
			...
			if($('#auditor_folder_holder').css('display') == "none" || $('#auditor_folder_holder').css('display') == "hidden" )
			{
				...
				$('.home_page').addClass('active_side_menu');
				$('.audit_folder').removeClass('active_side_menu');
	...
	//search results
     ...
     $(function() {
          ...
          dialog = $( "#dialog-form" ).dialog({
               ...
               modal: true,
               buttons: {
               	"Create an account": 	function() {	res=addUser();	if(res) {  load_user_list();	dialog.dialog( "close" ); }  	},
               	"Cancel": 			function() {	dialog.dialog( "close" );  	}
               },
               close: function() 
               {
     ...
     function addUser() 
     {
          ...
          valid = valid && checkLength( $('#password'), "password", 6, 80 );
     ...
     function modUser() 
     {
          var valid = true;
          $().removeClass( "ui-state-error" );
          //valid = valid && checkLength( $( "#user_name2" ), "username", 3, 16 );
