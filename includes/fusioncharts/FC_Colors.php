...
$arr_FCColors[1] = "AFD8F8"; // light blue
$arr_FCColors[2] = "F6BD0F"; // orange / yello
$arr_FCColors[3] = "8BBA00"; // light green
$arr_FCColors[4] = "A66EDD"; // purple
$arr_FCColors[5] = "9D080D" ; // red
$arr_FCColors[6] = "CCCC00" ;//Chrome Yellow+Green
$arr_FCColors[7] = "999999" ;//Grey
$arr_FCColors[8] = "0099CC" ;//Blue Shade
$arr_FCColors[9] = "F984A1" ;//pink
